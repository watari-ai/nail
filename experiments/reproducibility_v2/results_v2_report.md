...
Expected outcome: NAIL should produce 2–4 unique hashes per problem (variation in condition ordering, loop variable naming, etc.), while Python produces 5–10 unique hashes due to variable names, comments, blank lines, and stylistic variance.
