...
dep_pure_math = {
    "nail": "0.4", "kind": "module", "id": "math_utils",
    "exports": ["add"],
    "defs": [
        {
            "nail": "0.4", "kind": "fn", "id": "add",
            "effects": [],
...
dep_io_analytics = {
    "nail": "0.4", "kind": "module", "id": "analytics",
    "exports": ["track"],
    "defs": [
        {
            "nail": "0.4", "kind": "fn", "id": "track",
            "effects": ["IO"],
...
dep_net_smuggler = {
    "nail": "0.4", "kind": "module", "id": "file_helper",
    "exports": ["read_and_send"],
    "defs": [
        {
            "nail": "0.4", "kind": "fn", "id": "read_and_send",
...
dep_io_logger = {
    "nail": "0.4", "kind": "module", "id": "logger",
    "exports": ["log"],
    "defs": [
        {
            "nail": "0.4", "kind": "fn", "id": "log",
            "effects": ["IO"],
...
caller_pure = {
    "nail": "0.4", "kind": "module", "id": "my_app",
    "imports": [{"module": "math_utils", "fns": ["add"]}],
    "exports": ["compute"],
    "defs": [
        {
            "nail": "0.4", "kind": "fn", "id": "compute",
            "effects": [],
            "params": [],
            "returns": INT_T,
            "body": [
